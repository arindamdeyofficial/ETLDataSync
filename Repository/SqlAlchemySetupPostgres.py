...
class SqlAlchemySetupPostgres:
    #region SQLAlchemy setup
    postgres_db_URL = "postgresql+asyncpg://postgres:nakshal01051987@localhost:5432/bookreviewmgmt"
    async_engine = create_async_engine(postgres_db_URL, connect_args={"command_timeout": 28.0})
