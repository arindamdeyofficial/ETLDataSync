...
class BookDto(BaseEntity, SqlAlchemySetupPostgres.Base):
    __tablename__ = "books"
...
class ReviewDto(BaseEntity, SqlAlchemySetupPostgres.Base):
...
class UserDto(BaseEntity, SqlAlchemySetupPostgres.Base):
    __tablename__ = "users"
